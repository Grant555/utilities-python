...
# Date   : 16-7-10
# Version: 0.1
# Description: A very simple program which is designed for key word searching in files.
import queue
from mimetypes import guess_type
from tkinter import Frame, Label, Entry, Listbox, mainloop, Button, StringVar, Scrollbar
from threading import Thread
from tkinter.constants import *
from tkinter.filedialog import askdirectory
import os

DEFAULT_FONT = ('', 12, 'normal')
